...
Let's load the necessary packages. Links to more information about each package can be found in <a href="Component_Demos/00C_Robust_Issues.html"><span style = "color:green">`` `r "00B_Package_Descr_Refs"` ``</span></a>. Appropriate references for each package can be found in the "References" section at the end of this document.
...
## Coefficient processing {.tabset .tabset-fade .tabset-pills}
