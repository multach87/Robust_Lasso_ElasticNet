...
### Coefficient frequency processing
...
Let's walk through what's going on in the last code chunk. 
  ...
  * Seventh, map the _all()_ function over the rows of our intermediate data.table
  * Eighth, map the _none()_ function over the rows of our intermediate data.table
