...
I will not spend too much time explaining the models implemented by each of the following packages. Please see <span style = "color:green">`` `r "00A_Lasso_ENet_Adaptations"` ``</span> for an introduction the lasso, the elastic net, and the relevant adaptations, including rationale, mathematical formulation, and computational implementation.
...
An adapted version of **<span style = "color:blue">`` `r "gandh()"` ``</span>** for generating values from the **g-and-h distribution**. More details on this distribution can be found in <span style = "color:green">`` `r "01_Data_Generation"` ``</span>.
