...
Due to the nature of the topics covered, this section is **Very Math Heavy**. I recommend this section only for those interested in technical details of the adaptations that I am including in a forthcoming "combined model approach." Some familiarity with the mathematical formulation and expression of OLS regression will go a long way to supporting understanding of the following content.
