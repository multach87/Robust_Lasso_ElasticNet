...
### Visualization: Predictor Selection by Adaptation

#### Custom Color Palette

Let's create our custom color palette for the next multi-plot. Since there are only 7 lasso/elastic net adaptations among these models, we only need 7 colors.